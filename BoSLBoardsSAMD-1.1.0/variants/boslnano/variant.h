...
//Battery
#define ADC_BATTERY	(29u)

//nRF
#define nRF_SW_EN	(27u)
#define nRF_EN		(32u)
#define nRF_RST		(33u)
...
// Instances of SERCOM
extern SERCOM sercom0;//UART 2
extern SERCOM sercom1;//SPI
extern SERCOM sercom2;//I2C
extern SERCOM sercom3;//UART 3
extern SERCOM sercom4;//SPI SD
extern SERCOM sercom5;//UART NRF
